...
const navItems: NavItem[] = [
    ...
    // },
    {
        ...
        href: "/dashboard/user-password-reset",
        icon: Key,
    },
    {
        title: "Update User Contact",
        href: "/dashboard/update-user-phone-or-email",
        icon: Phone,
    },
    {
        title: "Settings",
            ...
            <Button size="sm" variant="secondary" className="w-full">
              ...
              Contact Support
                ...
                <div className="p-4 mt-auto border-t">
                    <Button
                        variant="outline"
                        className="w-full bg-gray-200 hover:bg-yellow-500 text-yellow-950 border-yellow-500 hover:text-yellow-950"
                        onClick={() => signOut()}
                    >
