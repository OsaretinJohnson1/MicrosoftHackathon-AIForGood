...
const navItems: NavItem[] = [
  ...
  // {
  //   title: "Payments",
  //   href: "/user-app/payments",
  //   icon: CreditCard,
  // },
  // {
  //   title: "Statements",
  //   href: "/user-app/statements",
  //   icon: FileText,
  // },
  {
    title: "Applications",
    href: "/user-app/applications",
    icon: FileText,
  },
  // {
  //   title: "Messages",
  //   href: "/user-app/messages",
  //   icon: MessageSquare,
  // },
  {
    title: "Profile",
    href: "/user-app/profile",
    icon: User,
  },
  // {
  //   title: "Settings",
        ...
        {/* <div className="p-4">
          <div className="rounded-lg bg-accent/50 p-4">
            ...
            <Button
              ...
              variant="secondary"
              className="w-full"
              onClick={() => window.alert("Opening support chat...")}
            >
