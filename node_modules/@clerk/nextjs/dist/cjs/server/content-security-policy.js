...
function createMergedCSP(strict, host, customDirectives, nonce) {
...
function createCSPHeader(strict, host, customDirectives) {
  const nonce = strict ? generateNonce() : void 0;
  return {
